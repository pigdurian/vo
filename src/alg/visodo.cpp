...
double getAbsoluteScale(int frame_id, int sequence_id, double z_cal)	{
  ...
  string line;
  int i = 0;
  ifstream myfile ("/mnt/hgfs/vo_data/data_odometry_gray/dataset1/poses/00.txt");
  double x =0, y=0, z = 0;
...
int main( int argc, char** argv )	{
  ...
  char filename1[200];
  char filename2[200];
  sprintf(filename1, "/mnt/hgfs/vo_data/data_odometry_gray/dataset/sequences/00/image_0/%06d.png", 0);
  sprintf(filename2, "/mnt/hgfs/vo_data/data_odometry_gray/dataset/sequences/00/image_0/%06d.png", 1);
  ...
  for(int numFrame=2; numFrame < MAX_FRAME; numFrame++)	{
  	sprintf(filename, "/mnt/hgfs/vo_data/data_odometry_gray/dataset/sequences/00/image_1/%06d.png", numFrame);
    //cout << numFrame << endl;
